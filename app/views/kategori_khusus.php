        ...
        <div class="content-header">
            <div class="penjelasan-buku">
                ...
                if (isset($_GET["id_buku"])) {
                    ...
                    $query = "SELECT * FROM tbkategori LEFT JOIN tbbuku ON tbkategori.id_kategori = tbbuku.kategori_id WHERE nama_kategori = '$kategori' ORDER BY RAND() LIMIT 1";
                }
